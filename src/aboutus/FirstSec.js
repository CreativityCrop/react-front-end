export default function FirstSec(){
    return(
        <div className="flex flex-row pt-28 select-none sm:flex-col sm:pt-4 ">
            <div className="bg-slate-300 ml-20 w-96 h-64 sm:order-2 sm:w-[21rem] sm:ml-auto sm:mr-auto">
                <p>img</p>
            </div>
            <div className="text-center w-[23rem] mr-20 ml-5 mt-14 h-auto sm:w-[21rem] sm:mb-10 sm:ml-auto sm:mr-auto">
