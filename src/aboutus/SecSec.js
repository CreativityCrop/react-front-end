...
export default function SecSec(){
    return(
        <div className="mt-28 sm:pb-10 flex flex-wrap justify-center items-center py-14 gap-16 md:gap-9 bg-yankeesblue text-slate-300"> 
            <img src="./assets/Illustrations/lilbuddy3.png" alt="" className="order-1 sm:order-2 "/>
            ...
            <img src="./assets/Illustrations/lilbuddy1.png" alt="" className="order-3 sm:order-3"/>
        </div>
    );
}