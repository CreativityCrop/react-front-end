    ...
    return(
        <div className="pt-28 select-none">
            <div id="holder" className="flex flex-row">
                <div className="text-center mr-20 ml-5 mt-8 h-56">
                    <h1 className="text-5xl mb-2">A marketplace for</h1>
                    <div className="max-w-30 content-center">
                        <h2 className="text-5xl mb-3 py-2 hover:text-red-600">ideas</h2>
                    </div>
